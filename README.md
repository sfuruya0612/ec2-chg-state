...
This is a sample template for ec2-ctrl - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name periodic-ec2-terminate \
...
aws cloudformation describe-stacks \
    --stack-name periodic-ec2-terminate --query 'Stacks[].Outputs'
```
